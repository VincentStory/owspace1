...
public class LoadMoreRecyclerView extends RecyclerView {
    private static final int NO_MORE_VIEW_HIDE_DELAY = 1000;
    ...
    public void setAdapter(Adapter adapter) {
        ...
        mFooterAdapter = new FooterAdapter(adapter, footerView);
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (RecyclerView.SCROLL_STATE_IDLE == state && mScrollingDown && null != mLoadMoreListener
            ...
            Log.d("LoadMore", "onScrollStateChanged: " + (layoutManager.getChildCount() > 0 && lastVisibleItemPosition >= layoutManager.getItemCount() - 1));
    ...
    public static class FooterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public FooterAdapter(RecyclerView.Adapter adapter, IFooterView footerView) {
